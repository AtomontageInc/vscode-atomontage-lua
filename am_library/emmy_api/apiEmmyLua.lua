...
![Getting Started](../../images/logo_tiny.png)
![Getting Started](../images/logo_tiny.png)
![Getting Started](./images/logo_tiny.png)
![Getting Started](./logo_tiny.png)
![Getting Started](./vscode-atomontage-lua/images/logo_tiny.png)

![Getting Started](../../out/logo_tiny.png)
![Getting Started](../out/logo_tiny.png)
![Getting Started](./out/logo_tiny.png)
![Getting Started](./logo_tiny.png)
![Getting Started](./vscode-atomontage-lua/out/logo_tiny.png)
...
--- @param message table data to send table may contain primitive math classes such as `Quat`, `Vec3` etc  
--- @return nil
